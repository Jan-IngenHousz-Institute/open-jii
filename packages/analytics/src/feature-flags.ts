...
export const FEATURE_FLAGS = {
  ...
  // Persisted PostHog keys keep the legacy "protocol-" prefix; only the
  // constant names track the protocol->command rename.
  COMMAND_VALIDATION_AS_WARNING: "protocol-validation-as-warning",
  COMMAND_DELETION: "protocol-deletion",
...
export const FEATURE_FLAG_DEFAULTS: Record<FeatureFlagKey, boolean> = {
  ...
  [FEATURE_FLAGS.COMMAND_VALIDATION_AS_WARNING]: true, // Default to warnings enabled
  [FEATURE_FLAGS.COMMAND_DELETION]: false, // Default to disabled for safety
