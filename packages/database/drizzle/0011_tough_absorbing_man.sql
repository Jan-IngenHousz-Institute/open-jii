...
CREATE TYPE "public"."chart_type" AS ENUM('line', 'scatter', 'bar', 'pie', 'area', 'dot-plot', 'heatmap', 'contour', 'carpet', 'ternary', 'parallel-coordinates', 'log-plot', 'wind-rose', 'radar', 'polar');--> statement-breakpoint
