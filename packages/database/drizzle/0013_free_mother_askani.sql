...
ALTER TABLE "experiment_visualizations" ADD CONSTRAINT "experiment_visualizations_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "experiment_locations" DROP COLUMN "created_at";--> statement-breakpoint
ALTER TABLE "experiment_locations" DROP COLUMN "updated_at";