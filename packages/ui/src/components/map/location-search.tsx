    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          disabled={disabled}
          className="focus:border-jii-dark-green focus:ring-jii-dark-green/20 w-full rounded-lg border border-gray-300 bg-white px-10 py-2 text-sm focus:outline-hidden focus:ring-2 disabled:bg-gray-50 disabled:text-gray-500"
        />
        {isLoading && (
            ...
            <div className="max-h-64 overflow-y-auto">
              {results.map((location: LocationSearchResult, index: number) => (
                <button
                  ...
                  className={`w-full px-4 py-3 text-left text-sm hover:bg-gray-50 focus:bg-gray-50 focus:outline-hidden ${
