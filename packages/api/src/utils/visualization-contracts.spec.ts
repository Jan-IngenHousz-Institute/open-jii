...
import type { ChartDataConfig, ChartType, DataColumn } from "../schemas/experiment.schema";
import { WellKnownColumnTypes } from "../schemas/experiment.schema";
import {
...
const UNREGISTERED = "__synthetic_unregistered__" as ChartType;
