...
/**
 * Known MultispeQ console commands that can be sent verbatim from a workbook
 * command cell. These are the parameter-free diagnostic / status / calibration
 * commands; parameterised commands (e.g. `set_colorcal1+…`) are intentionally
 * excluded here and handled by dynamic command payload binding (OJD-1603).
 *
...
export type DeviceCommand = z.infer<typeof zDeviceCommand>;
