...
@Injectable()
export class ListDeviceCalibrationsUseCase {
  constructor(private readonly runRepository: IotCalibrationRunRepository) {}

  execute(deviceId: string): Promise<Result<DeviceCalibrationDto[]>> {
    return this.runRepository.listCalibrationsByDevice(deviceId);
  }
}
