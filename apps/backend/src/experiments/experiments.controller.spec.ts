...
describe('ExperimentsController', () => {
  ...
  describe('findAll', () => {
    it('should find all experiments with valid filters', async () => {
      const validFilters: ExperimentFilter[] = ['my', 'member', 'related', undefined];
  ...
  describe('update', () => {
    ...
    it('should update with valid partial data', async () => {
      ...
      await controller.update('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', updateDto);
      expect(service.update).toHaveBeenCalledWith('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', updateDto);
    });
    ...
    it('should update with empty data', async () => {
      ...
      expect(service.update).toHaveBeenCalledWith('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', emptyDto);
    });
  });
}); 