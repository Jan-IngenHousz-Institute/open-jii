  ...
  async execute(experimentId: string, userId: string): Promise<Result<void>> {
    ...
    return accessResult.chain(
      async ({
        ...
        const existingResult = await this.experimentMetadataRepository.findByExperimentId(
          experimentId
        );
        ...
        // Delete metadata
        const deleteResult = await this.experimentMetadataRepository.deleteByExperimentId(
          experimentId
        );
