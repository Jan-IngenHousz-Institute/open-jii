  ...
  async execute(
    ...
    return accessResult.chain(
      async ({
        ...
        // Defense in depth: confirm the dashboard's experiment matches the
        // path. The path is also access-checked above, but a mismatched id
        // pair would otherwise leak data across experiments.
