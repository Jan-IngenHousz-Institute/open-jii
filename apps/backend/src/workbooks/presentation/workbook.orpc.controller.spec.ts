...
describe("WorkbookOrpcController", () => {
  ...
  describe("createWorkbook", () => {
    it("should successfully create a workbook", async () => {
      ...
      const response = await testApp
        .post(testApp.resolveOrpcPath(orpcContract.workbooks.createWorkbook))
        .withAuth(testUserId)
  ...
  describe("getWorkbook", () => {
    it("should return a workbook by ID", async () => {
      ...
      const path = testApp.resolveOrpcPath(orpcContract.workbooks.getWorkbook, { id: mock.id });
    ...
    it("should return 404 for non-existent workbook", async () => {
      ...
      const path = testApp.resolveOrpcPath(orpcContract.workbooks.getWorkbook, { id });
  ...
  describe("listWorkbooks", () => {
    it("should return a list of workbooks", async () => {
      ...
      const response = await testApp
        .get(testApp.resolveOrpcPath(orpcContract.workbooks.listWorkbooks))
        .withAuth(testUserId)
  ...
  describe("updateWorkbook", () => {
    it("should update a workbook", async () => {
      ...
      const path = testApp.resolveOrpcPath(orpcContract.workbooks.updateWorkbook, { id: mock.id });
      const response = await testApp
        .patch(path)
        .withAuth(testUserId)
    ...
    it("should return 403 for non-owner update", async () => {
      ...
      const id = faker.string.uuid();
      const path = testApp.resolveOrpcPath(orpcContract.workbooks.updateWorkbook, { id });
      await testApp
        .patch(path)
        .withAuth(testUserId)
        .send({ name: "Nope" })
  ...
  describe("deleteWorkbook", () => {
    it("should delete a workbook", async () => {
      ...
      const id = faker.string.uuid();
      const path = testApp.resolveOrpcPath(orpcContract.workbooks.deleteWorkbook, { id });
  ...
  describe("listWorkbookVersions", () => {
    ...
    it("should list versions for a workbook", async () => {
      ...
      const path = testApp.resolveOrpcPath(orpcContract.workbooks.listWorkbookVersions, {
        id: workbookId,
      });
      const response = await testApp.get(path).withAuth(testUserId).expect(StatusCodes.OK);
  ...
  describe("getWorkbookVersion", () => {
    ...
    it("should return a specific version", async () => {
      ...
      const path = testApp.resolveOrpcPath(orpcContract.workbooks.getWorkbookVersion, {
