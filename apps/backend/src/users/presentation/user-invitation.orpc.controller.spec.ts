...
describe("InvitationOrpcController", () => {
  ...
  describe("createInvitation", () => {
    it("should create an invitation and return 201", async () => {
      ...
      const path = testApp.resolveOrpcPath(orpcContract.users.createInvitation, {});
  ...
  describe("listInvitations", () => {
    it("should return pending invitations for a resource", async () => {
      ...
      const createPath = testApp.resolveOrpcPath(orpcContract.users.createInvitation, {});
      await testApp
        .post(createPath)
        .withAuth(testUserId)
        .send({
      ...
      // Now list
      const listPath = testApp.resolveOrpcPath(orpcContract.users.listInvitations, {});
  ...
  describe("updateInvitationRole", () => {
    it("should update invitation role and return 200", async () => {
      ...
      const updatePath = testApp.resolveOrpcPath(orpcContract.users.updateInvitationRole, {
        invitationId,
      });
  ...
  describe("revokeInvitation", () => {
    it("should revoke an invitation and return 204", async () => {
      ...
      const invitationId = createResponse.body.id;
      const revokePath = testApp.resolveOrpcPath(orpcContract.users.revokeInvitation, {
        invitationId,
      });
