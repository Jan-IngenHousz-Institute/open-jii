...
@Controller()
export class ProtocolOrpcController {
  private readonly logger = new Logger(ProtocolOrpcController.name);
  ...
  @Implement(protocolOrpcContract.listProtocols)
  listProtocols(@Session() session: UserSession) {
    return implement(protocolOrpcContract.listProtocols).handler(async ({ input }) => {
  ...
  @Implement(protocolOrpcContract.getProtocol)
  getProtocol() {
    return implement(protocolOrpcContract.getProtocol).handler(async ({ input }) => {
  ...
  @Implement(protocolOrpcContract.updateProtocol)
  updateProtocol(@Session() session: UserSession) {
    return implement(protocolOrpcContract.updateProtocol).handler(async ({ input }) => {
      const { id, ...body } = input;
  ...
  @Implement(protocolOrpcContract.deleteProtocol)
  deleteProtocol(@Session() session: UserSession) {
    return implement(protocolOrpcContract.deleteProtocol).handler(async ({ input }) => {
  ...
  @Implement(protocolOrpcContract.listCompatibleMacros)
  listCompatibleMacros() {
    return implement(protocolOrpcContract.listCompatibleMacros).handler(async ({ input }) => {
  ...
  @Implement(protocolOrpcContract.addCompatibleMacros)
  addCompatibleMacros(@Session() session: UserSession) {
    return implement(protocolOrpcContract.addCompatibleMacros).handler(async ({ input }) => {
  ...
  @Implement(protocolOrpcContract.removeCompatibleMacro)
  removeCompatibleMacro(@Session() session: UserSession) {
    return implement(protocolOrpcContract.removeCompatibleMacro).handler(async ({ input }) => {
