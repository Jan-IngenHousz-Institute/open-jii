  ...
  describe("getExperimentTableMetadata", () => {
    ...
    it("should successfully retrieve table metadata with schemas", async () => {
      const mockMetadata = {
        ...
        rows: [
          ["raw_data", "static", null, "100", "2026-09-22T10:05:00.000Z", null, null, null, null],
          ["device", "static", null, "50", null, null, null, null, null],
          [
            "some_macro_id",
            "macro",
            null,
    ...
    it("should retrieve metadata for specific table only", async () => {
      const mockMetadata = {
        ...
        rows: [["device", "static", null, "50", null, null, null, null, null]],
        totalRows: 1,
        truncated: false,
      };
    ...
    it("should exclude schemas when includeSchemas is false", async () => {
      const mockMetadata = {
        ...
        rows: [
          ["raw_data", "static", null, "100", "2026-09-22T10:05:00Z"],
          ["device", "static", null, "50", null],
        ],
        totalRows: 2,
        truncated: false,
      };
