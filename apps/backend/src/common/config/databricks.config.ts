...
export default registerAs("databricks", () => ({
  ...
  dataUploadJobId: process.env.DATABRICKS_DATA_UPLOAD_JOB_ID,
  ...
  metricsSchemaName: process.env.DATABRICKS_METRICS_SCHEMA_NAME,
  ...
  uploadedDataTableName: process.env.DATABRICKS_UPLOADED_DATA_TABLE_NAME,
}));
