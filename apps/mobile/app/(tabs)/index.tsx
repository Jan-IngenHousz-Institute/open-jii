...
export default function HomeScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.isDark ? colors.dark.background : colors.light.background }]}>
      ...
      >
        <Text style={[styles.welcomeText, { color: theme.isDark ? colors.dark.onSurface : colors.light.onSurface }]}>
          Welcome to MultiSpeq
        </Text>
        <Text style={[styles.subtitleText, { color: theme.isDark ? colors.dark.inactive : colors.light.inactive }]}>
