...
export default function ExperimentsScreen() {
  ...
  const getMeasurementsForSelectedExperiment = () => {
    ...
    return mockMeasurements[selectedExperiment as keyof typeof mockMeasurements] || [];
  };
  ...
  const renderMeasurementItem = ({ item }: { item: any }) => {
    return (
      <MeasurementResult
        ...
        experimentName={mockExperiments.find(e => e.value === selectedExperiment)?.label}
      />
    );
  };
      ...
      {selectedExperiment ? (
        <View style={styles.measurementsContainer}>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <Text style={[styles.emptyText, { color: theme.isDark ? colors.dark.inactive : colors.light.inactive }]}>
        ...
        <View style={styles.placeholderContainer}>
          <Text style={[styles.placeholderText, { color: theme.isDark ? colors.dark.inactive : colors.light.inactive }]}>
