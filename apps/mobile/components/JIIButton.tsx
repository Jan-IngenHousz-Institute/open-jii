...
export default function JIIButton({
  ...
  const getPadding = () => {
    switch (size) {
      case 'sm':
        return { paddingVertical: layout.radiusSmall, paddingHorizontal: layout.radiusMedium };
      case 'lg':
        return { paddingVertical: layout.radiusMedium, paddingHorizontal: layout.radiusLarge };
      default:
        return { paddingVertical: layout.radiusSmall * 2, paddingHorizontal: layout.radiusMedium * 2 };
    }
  };
