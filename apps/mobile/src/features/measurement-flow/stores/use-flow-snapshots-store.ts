...
// partialize). Resume reads it from here, so a paused flow comes back offline
// regardless of the query cache (cache buster on app update, eviction).
// Cleared by teardownFlow and the rehydration guard.
