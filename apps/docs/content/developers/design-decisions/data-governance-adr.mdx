...
description: "Historical ADR accepted on 2025-03-05."
---

{/* verified: code@12a361a74966 2026-07-19 */}

> Historical record: this accepted ADR is preserved without changing its substance. It describes a dual-schema model that is not the current implementation. See [Medallion layers](/developers/architecture/medallion-layers) for the present central `centrum` model.
