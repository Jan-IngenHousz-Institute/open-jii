...
Read [Identity & access management](/developers/architecture/identity-access-management),
[Data ingestion](/developers/architecture/data-ingestion),
[Time synchronization](/developers/architecture/time-synchronization),
[Medallion layers](/developers/architecture/medallion-layers), and
[Pipeline compute](/developers/architecture/pipeline-compute) for the detailed
paths. Contract details live in the [REST](/api/rest) and [MQTT](/api/mqtt)
references.
