...
A transitional legacy shape with a trailing `{protocolId}` segment remains routed for already-fielded mobile builds; it is removed once those roll over. New publishers use the shape above.
