...
Prerequisites are Node.js 22 (`.nvmrc`), Corepack/pnpm, and Docker for services used by the selected app. Work in `apps/data` additionally requires [uv](https://docs.astral.sh/uv/).
