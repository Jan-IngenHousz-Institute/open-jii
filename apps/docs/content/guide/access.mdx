...
![A collaborators list showing every row kind: a named owner marked Owner · via organization, counted Admins and Members summary rows, a team, an Outside Collaborator, and a member whose row carries both Member · via organization and Redundant grant](/img/guide/web/collaborators.png)
...
- **A badge like "Admin · via organization"** names their *other* route in. It is telling
