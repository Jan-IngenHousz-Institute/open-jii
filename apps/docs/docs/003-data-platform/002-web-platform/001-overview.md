...
- **Secure authentication & access control:** Magic-link email login, ORCID and GitHub sign-in, plus role-based access and configurable visibility (Public/Private). See [Register](./0012-register.md) to create an account.
