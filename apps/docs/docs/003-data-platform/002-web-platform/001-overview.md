...
- **Command-macro compatibility:** Many-to-many linking between commands and macros, with sort order and preferred badges — see [Commands / Macros](./0014-command.md).
...
- **Project transfers:** Import experiments, commands, and measurement data from external platforms.
