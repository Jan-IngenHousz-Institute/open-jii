...
The MultispeQ sensor/device is a product of [PhotosynQ](https://www.photosynq.com). It works seamlessly with the [openJII mobile app](./002-mobile-app.md) to do measurements.
