...
- **QR code scanning:** scan QR codes to populate answers in NumberQuestion and OpenEndedQuestion inputs, or to search MultipleChoiceQuestion options. Uses the device camera for faster data entry compared to manual typing. Requires camera permissions.
