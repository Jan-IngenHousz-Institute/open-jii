...
describe("useCreateIotDeviceGroup", () => {
  it("sends the create body", async () => {
    const spy = server.mount(contract.deviceGroups.createDeviceGroup, {
      body: createDeviceGroup(),
    });
  ...
  it("calls onSuccess with the created group", async () => {
    server.mount(contract.deviceGroups.createDeviceGroup, {
      body: createDeviceGroup({ id: "11111111-1111-4111-8111-111111111111" }),
    });
  ...
  it("surfaces an error response", async () => {
    server.mount(contract.deviceGroups.createDeviceGroup, { status: 403 });
