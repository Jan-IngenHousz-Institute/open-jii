...
import { useExperimentDataCommentsDelete } from "./useExperimentDataCommentsDelete";
...
describe("deleteExperimentDataComments", () => {
  ...
  it("should call useMutation with correct onSuccess handler", () => {
    ...
    (mockTsr.experiments.deleteExperimentDataComments.useMutation as unknown) = mockUseMutation;

    renderHook(() => useExperimentDataCommentsDelete(), { wrapper: deleteWrapper() });
