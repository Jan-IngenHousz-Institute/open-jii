...
describe("useExperimentVisualizationDelete", () => {
  ...
  it("should call useMutation with correct configuration", () => {
    ...
    mockTsr.experiments.deleteExperimentVisualization.useMutation = mockUseMutation;

    renderHook(() => useExperimentVisualizationDelete({ experimentId: "exp-123" }), {
  ...
  describe("onMutate callback", () => {
    it("should cancel queries and return previous data", async () => {
      ...
      mockTsr.experiments.deleteExperimentVisualization.useMutation = vi.fn((opts: any) => {
  ...
  describe("onSuccess callback", () => {
    it("should call onSuccess callback when provided", () => {
      ...
      renderHook(
        () =>
          useExperimentVisualizationDelete({
