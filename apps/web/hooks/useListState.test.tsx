...
describe("useListState", () => {
  ...
  it("cycles a single sort and removes it from the URL", () => {
    const { result } = renderHook(() => useListState(zExperimentSort));
  ...
  it("restores valid URL sorting and ignores invalid fields", () => {
    ...
    const { result, unmount } = renderHook(() => useListState(zExperimentSort));
    ...
    expect(renderHook(() => useListState(zExperimentSort)).result.current.sort).toEqual([]);
  });
