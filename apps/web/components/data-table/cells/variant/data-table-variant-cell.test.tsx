...
import { DataTableVariantCell, VariantExpandedContent } from "./data-table-variant-cell";

describe("DataTableVariantCell", () => {
  ...
  it("should render empty string as simple text", () => {
    render(<DataTableVariantCell data="" columnName="test" rowId="test-row" isExpanded={false} />);
