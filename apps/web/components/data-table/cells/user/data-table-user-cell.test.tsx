...
import { DataTableUserCell } from "./data-table-user-cell";

describe("DataTableUserCell", () => {
  it("renders user with avatar and name", () => {
    ...
    render(<DataTableUserCell data={userData} columnName="User" />);
  ...
  it("renders nothing for empty name", () => {
    ...
    const { container } = render(<DataTableUserCell data={userData} columnName="User" />);

    expect(container.textContent).toBe("");
  });

  it("handles invalid JSON gracefully", () => {
    const { container } = render(<DataTableUserCell data="invalid-json" columnName="User" />);
  ...
  it("handles invalid user object gracefully", () => {
    ...
    const { container } = render(<DataTableUserCell data={invalidData} columnName="User" />);
  ...
  it("handles parsed data that is not an object", () => {
    ...
    const { container } = render(<DataTableUserCell data={notAnObject} columnName="User" />);
  ...
  it("handles null parsed data", () => {
    ...
    const { container } = render(<DataTableUserCell data={nullData} columnName="User" />);
  ...
  it("handles parsed data that is an array", () => {
    ...
    const { container } = render(<DataTableUserCell data={arrayData} columnName="User" />);
  ...
  it("handles parsed data missing required fields", () => {
    ...
    const { container } = render(<DataTableUserCell data={missingId} columnName="User" />);
  ...
  it("handles exception during JSON parsing", () => {
    ...
    const { container } = render(<DataTableUserCell data={malformedJSON} columnName="User" />);
  ...
  it("handles JSON parsing exception with nested try-catch", () => {
    ...
    const { container } = render(<DataTableUserCell data={badJSON} columnName="User" />);
