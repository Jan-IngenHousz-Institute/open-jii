...
import { DataTableArrayCell, ArrayExpandedContent } from "./data-table-array-cell";

describe("DataTableArrayCell", () => {
  ...
  it("should render empty array message for empty array data", () => {
    render(<DataTableArrayCell data="[]" columnName="test" rowId="test-row" isExpanded={false} />);
  ...
  it("should expand and show items when triggered", async () => {
    ...
    render(
      <DataTableArrayCell data={testData} columnName="test" rowId="test-row" isExpanded={false} />,
    );
