...
import { DataTableMapCell, MapExpandedContent } from "./data-table-map-cell";

describe("DataTableMapCell", () => {
  it("should render simple text for non-map data", () => {
    render(
      <DataTableMapCell data="simple text" columnName="test" rowId="test-row" isExpanded={false} />,
    );
    expect(screen.getByText("simple text")).toBeInTheDocument();
  });

  it("should render empty map message", () => {
    render(<DataTableMapCell data="{}" columnName="test" rowId="test-row" isExpanded={false} />);
