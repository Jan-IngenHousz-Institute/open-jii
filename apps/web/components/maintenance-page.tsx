...
export function MaintenancePage() {
  return (
    <div className="bg-background fixed inset-0 flex flex-col items-center justify-center px-4 py-16">
      <div className="w-full max-w-md text-center">
        ...
        <h1 className="text-foreground mb-4 text-4xl font-bold">We&apos;ll be back soon</h1>
