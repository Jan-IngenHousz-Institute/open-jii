...
export function DangerZoneCard({ profile, userId }: DangerZoneCardProps) {
  ...
  return (
    <SettingsCard
      ...
      headerExtra={<DocsHelpLink path="/guide/reference/access-troubleshooting" className="mt-1" />}
    ...
    >
      ...
      <div className="border-destructive/25 bg-destructive/5 flex flex-col gap-4 rounded-md border p-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground text-sm">{t("dangerZone.deactivate.description")}</p>
        </div>
        ...
        >
          ...
          <DialogContent className="max-w-md">
            ...
            <InsetPanel tone="destructive" className="mt-3 text-sm">
