...
export async function AuthHeroSection({ locale }: AuthHeroSectionProps) {
  ...
  return (
    <div className="text-sidebar-foreground hidden h-full w-full flex-col items-start justify-center md:flex">
      ...
      <p className="text-sidebar-foreground mt-5 max-w-2xl text-lg sm:text-xl md:text-2xl">
        {t("auth.heroDescription")}
      </p>

      <div className="text-sidebar-foreground mt-10 flex items-center gap-3">
        <Image
