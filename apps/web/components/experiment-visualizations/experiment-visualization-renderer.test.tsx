...
describe("ExperimentVisualizationRenderer", () => {
  ...
  it("dispatches to LineRenderer for chartType=line", () => {
    ...
    render(<ExperimentVisualizationRenderer visualization={visualization} experimentId={experimentId} />);
  ...
  it("dispatches to ScatterRenderer for chartType=scatter", () => {
    ...
    render(<ExperimentVisualizationRenderer visualization={visualization} experimentId={experimentId} />);
    expect(screen.getByTestId("scatter-chart-renderer")).toHaveTextContent("Scatter Chart: My Scatter");
  });
