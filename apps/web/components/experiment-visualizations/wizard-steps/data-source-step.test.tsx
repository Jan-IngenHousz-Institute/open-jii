...
const mockTables: ExperimentTableMetadata[] = [
  { identifier: "measurements", tableType: "static", displayName: "Measurements", totalRows: 100 },
  { identifier: "sensors", tableType: "static", displayName: "Sensors", totalRows: 50 },
];
...
function setupExperimentData() {
  vi.mocked(useExperimentData).mockImplementation(({ tableName }: { tableName?: string }) => {
    ...
    const table = mockTables.find((t) => t.identifier === tableName);
