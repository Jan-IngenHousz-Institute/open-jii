                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select value={field.value} onValueChange={field.onChange}>
                      ...
                      <SelectContent>
                        <SelectItem value="vertical">{t("orientations.vertical")}</SelectItem>
                        <SelectItem value="horizontal">{t("orientations.horizontal")}</SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                  </FormItem>
