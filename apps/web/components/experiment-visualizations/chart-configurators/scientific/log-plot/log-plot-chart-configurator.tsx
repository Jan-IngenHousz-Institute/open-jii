...
import { TrendingUp, Layers, Eye, Plus, Trash2, Palette, Database } from "lucide-react";
...
export default function LogPlotChartConfigurator({
  ...
  const addYAxisSeries = () => {
    appendYAxis({
      ...
      type: "log", // Default to log scale for log plots
      side: "left",
      title: "",
