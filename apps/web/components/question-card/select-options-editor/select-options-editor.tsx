            ...
            {options.map((option, optionIndex) => (
              <div key={optionIndex} className="group/option flex items-center gap-3">
                ...
                <input
                  ...
                  disabled={disabled}
                  className="focus:border-jii-dark-green focus:ring-jii-dark-green/20 flex-1 rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 placeholder-gray-500 transition-colors focus:bg-white focus:outline-hidden focus:ring-2 disabled:cursor-not-allowed disabled:bg-gray-100"
                />
                <button
                  type="button"
