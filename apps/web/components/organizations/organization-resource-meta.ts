...
/**
 * Where each owned type's detail page lives on the platform. All five: the resources
 * card links rows here, and so does the team-grants list, which can name a device.
 */
