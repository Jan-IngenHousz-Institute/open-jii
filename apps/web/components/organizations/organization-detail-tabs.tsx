...
/**
 * One route per tab. Overview exists for anyone who can see the organization at
 * all; members get the management routes; settings are owner-only, and the
 * absence of the tab is the first half of that — the routes refuse independently.
 *
 * An outsider on a public organization sees a bare profile rather than a lone tab.
 */
