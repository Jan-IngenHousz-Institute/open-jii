...
export function ExperimentSidePanel({
  ...
  return (
    <>
      ...
      <div
        className={
          "fixed inset-0 z-[20] bg-black transition-opacity duration-300 " +
          (open && nodeType
      ...
      <div
        className={
          "fixed bottom-0 right-0 top-0 z-[20] flex w-full flex-col rounded-none border-none bg-white shadow-none transition-transform duration-300 ease-in-out " +
