...
EXPORT_ID = dbutils.widgets.get("EXPORT_ID")  # UUID generated by the backend (replaces DOWNLOAD_ID)
...
EXPORT_METADATA_TABLE = f"{CATALOG_NAME}.centrum.experiment_data_exports"
