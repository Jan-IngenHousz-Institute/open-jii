...
output "function_names" {
  description = "Lambda function names keyed by language (stub until Lambda is enabled)"
  value       = {}
}

output "invoke_policy_arn" {
  description = "IAM policy ARN granting lambda:InvokeFunction (stub until Lambda is enabled)"
  value       = null
}
