...
#' Extract every n-th element from a vector
...
info <- function(msg, output) {
  ...
  message_obj <- list(type = "info", message = msg)
  output$messages <- append(output$messages, list(message_obj))
...
warning <- function(msg, output) {
  ...
  message_obj <- list(type = "warning", message = msg)
  output$messages <- append(output$messages, list(message_obj))
...
danger <- function(msg, output) {
  ...
  message_obj <- list(type = "danger", message = msg)
  output$messages <- append(output$messages, list(message_obj))
