...
module "gha_opennext_deploy_oidc_role" {
  ...
  role_name          = "GithubActions-Nextjs-Deploy-Dev-Role"
...
module "gha_backend_deploy_oidc_role" {
  source             = "../../modules/iam-oidc"
  role_name          = "GithubActions-Backend-Deploy-Dev-Role"
  repository         = "Jan-IngenHousz-Institute/open-jii"
  github_environment = "dev"
  aws_region         = var.aws_region
  environment        = var.environment
...
module "gha_db_migration_oidc_role" {
  source             = "../../modules/iam-oidc"
  role_name          = "GithubActions-DBMigration-Dev-Role"
  repository         = "Jan-IngenHousz-Institute/open-jii"
  github_environment = "dev"
  aws_region         = var.aws_region
  environment        = var.environment
...
module "gha_terraform_oidc_role" {
  source      = "../../modules/iam-oidc"
  role_name   = "GithubActions-Terraform-Dev-Role"
  repository  = "Jan-IngenHousz-Institute/open-jii"
  branch      = "main"
  aws_region  = var.aws_region
  environment = var.environment
