...
module "centrum_pipeline" {
  ...
  notebook_paths = [
    ...
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/centrum/gold/latest_experiment_activity",
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/centrum/gold/latest_device_data",
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/centrum/gold/latest_device_event",
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/centrum/gold/latest_experiment_device",
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/centrum/gold/experiment_raw_data_schemas",
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/centrum/gold/experiment_uploaded_data_schemas",
...
module "macro_execution_pipeline" {
  ...
  notebook_paths = [
    ...
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/macros/experiment_macro_data_schemas",
  ]
...
module "metrics_pipeline" {
  ...
  notebook_paths = [
    ...
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/metrics/experiment_devices_window",
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/metrics/daily_activity_by_resource",
    # ops: read by the heartbeat export, never by the public endpoint
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/metrics/ops_device_silence",
    "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/pipelines/metrics/ops_ingest_quality",
  ]
  ...
  tasks = [
    {
      ...
      task_type     = "notebook"
      compute_type  = "serverless"
      notebook_path = "/Workspace/Shared/.bundle/open-jii/prod/notebooks/src/tasks/data_export_task"
